  ...
  <div v-if="screening">
    ...
    <section>
      ...
      <p v-if="screening.movie">
        <NuxtLink :to="`/movies/${screening.movie.slug?.current}`">
    ...
    <section v-if="screening.infoUrl">
      <h2>More Info</h2>
      <p>
        <a :href="screening.infoUrl" target="_blank" rel="noopener noreferrer">
          {{ screening.infoUrl }}
        </a>
      </p>
    </section>
    ...
    <section v-if="screening.ticketUrl">
      <h2>Ticket</h2>
      <p>
        <a :href="screening.ticketUrl" target="_blank" rel="noopener noreferrer">
          Download Ticket (PDF)
        </a>
      </p>
    </section>
